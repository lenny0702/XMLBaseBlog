...
<div class="p"><p class="text">發佈版本： WeChat {$log->version} for iPhone. <a href="/cgi-bin/download302?fr=www.wechat.com&lang=zh_TW&url=ios" target="_blank" onClick="trackOutboundLink(this, 'Download', 'download_link','ios'); return false;" >請到App Store下載</a>（或到手機App Store搜尋“WeChat”）。</p></div>
