...
<div class="p"><p class="text">發佈版本： WeChat {$log->version} for BlackBerry. <a href="/cgi-bin/download302?fr=www.wechat.com&lang=zh_TW&url=blackberry{$log->downloadVersion}" onClick="trackOutboundLink(this, 'Download', 'download_link','bb'); return false;" >直接下載安裝包</a></p></div>
