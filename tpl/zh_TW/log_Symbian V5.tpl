...
<div class="p"><p class="text">發佈版本：WeChat {$log->version} for Symbian V5. <a href="/cgi-bin/download302?fr=www.wechat.com&lang=zh_TW&url=symbian_v5{$log->downloadVersion}" onClick="trackOutboundLink(this, 'Download', 'download_link','symbianv5_package'); return false;" >直接下載安裝包</a>，<a href="/cgi-bin/download302?fr=www.wechat.com&lang=zh_TW&url=symbian_v5" target="_blank" onClick="trackOutboundLink(this, 'Download', 'download_link','symbianv5'); return false;" >你也可以選按此處前往 Ovi Store下載</a>（或到手機Ovi Store搜尋“WeChat”）。</p></div>
