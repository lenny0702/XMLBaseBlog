...
<div class="p"><p class="text">Release Version: WeChat {$log->version} for Symbian V5. <a href="/cgi-bin/download302?fr=www.wechat.com&lang=en&url=symbian_v5{$log->downloadVersion}" onClick="trackOutboundLink(this, 'Download', 'download_link','symbianv5_package'); return false;" >Download now</a>.<a href="/cgi-bin/download302?fr=www.wechat.com&lang=en&url=symbian_v5" target="_blank" onClick="trackOutboundLink(this, 'Download', 'download_link','symbianv5'); return false;" >or go to OVI Store</a>(or search "WeChat" in Ovi Store).</p></div>
