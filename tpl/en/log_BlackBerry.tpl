...
<div class="p"><p class="text">Release Version: WeChat {$log->version} for BlackBerry. <a href="/cgi-bin/download302?fr=www.wechat.com&lang=en&url=blackberry{$log->downloadVersion}" onClick="trackOutboundLink(this, 'Download', 'download_link','bb'); return false;" >Download now</a></p></div>
